            ...
            {step === 1 ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input 
                        ...
                        className="mt-1 block w-full border-gray-300 rounded-sm shadow-sm focus:ring-gold-500 focus:border-gold-500 sm:text-sm p-2 border" 
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input 
                          ...
                          value={formData.date}
                          onChange={handleChange}
                          className="focus:ring-gold-500 focus:border-gold-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-sm p-2 border" 
                        />
                      </div>
                    </div>
                    ...
                    <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                      <button
                        type="submit"
                        disabled={isSending}
                        className="w-full inline-flex justify-center rounded-sm border border-transparent shadow-sm px-4 py-2 bg-black text-base font-medium text-white hover:bg-gray-800 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm uppercase tracking-wider disabled:opacity-50"
                      >
              ...
              <div className="text-center py-10">
                ...
                <p className="text-sm text-gray-500 mb-6">
                  ...
                  Vi sjekker tilgjengelighet og sender deg en bekreftelse.
                </p>
                
                <div className="mb-6">
                  <a 
                    href={smsLink}
                    className="inline-flex items-center justify-center w-full rounded-sm border border-transparent shadow-sm px-6 py-3 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none sm:text-sm uppercase tracking-wider mb-3"
                  >
                    <MessageSquare className="mr-2 h-4 w-4" />
                    Send SMS for raskere svar
                  </a>
                  <p className="text-xs text-gray-400">
                    Dette åpner SMS-appen på din telefon med en ferdig utfylt melding.
                  </p>
                </div>

                <button
                  type="button"
                  className="inline-flex justify-center rounded-sm border border-gray-300 shadow-sm px-6 py-2 bg-white text-base font-medium text-gray-700 hover:text-gray-500 focus:outline-none sm:text-sm uppercase tracking-wider"
                  onClick={() => {
                    setStep(1);
                    onClose();
